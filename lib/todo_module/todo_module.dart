...
class TodoModule extends Module {
  ...
  FutureOr<Response> getTodoById(ModularArguments args, Request request) =>
      Modular.get<GetTodoByIdController>().getTodoById(args, request);
  ...
  FutureOr<Response> updateTodo(ModularArguments args, Request request) =>
      Modular.get<UpdateTodoController>().updateTodo(args, request);
