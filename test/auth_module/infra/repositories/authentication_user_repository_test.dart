...
class AuthenticationUserMock extends Mock implements IAuthenticationUserDatasource {}
...
main() {
  ...
  test('must return UserEntity', () async {
    when(() => datasource.authenticationUser(any())).thenAnswer(
  ...
  test('must return IFailureLogin from daatsource', () async {
    when(() => datasource.authenticationUser(params)).thenThrow(LoginCredentialsError());
